        ...
        <div class="flex flex-wrap">
            <aside class="sticky top-[4rem] w-full md:w-1/4 bg-white text-black p-5 h-[calc(100vh-4rem)] overflow-y-auto shadow-lg border border-gray-300 rounded-lg">
                ...
                <nav class="space-y-2 ">
                    ...
                    <button data-category-btn="breakfast" onclick="filterMenu('breakfast')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/breakfast.png" alt="breakfast" class="h-8 w-8 mr-2"> Breakfast
                    </button>
                    <button data-category-btn="burgers" onclick="filterMenu('burgers')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/Burgers.png" alt="burgers" class="h-8 w-8 mr-2"> Burgers
                    </button>
                    <button data-category-btn="chickenjoy" onclick="filterMenu('chickenjoy')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/chickenjoy.png" alt="Jolly chickenjoy" class="h-8 w-8 mr-2"> Chickenjoy
                    </button>
                    <button data-category-btn="jollyhotdog" onclick="filterMenu('jollyhotdog')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/hotdog.png" alt="Jolly Hotdog" class="h-8 w-8 mr-2"> Jolly Hotdog
                    </button>
                    <button data-category-btn="spaghetti" onclick="filterMenu('spaghetti')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/jolly.png" alt="Jolly Spaghetti" class="h-8 w-8 mr-2"> Jolly Spaghetti
                    </button>
                    <button data-category-btn="burgersteak" onclick="filterMenu('burgersteak')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/steak.png" alt="Burger Steak" class="h-8 w-8 mr-2"> Burger Steak
                    </button>
                    <button data-category-btn="beverages" onclick="filterMenu('beverages')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/cokess.png" alt="Burger Steak" class="h-8 w-8 mr-2"> Beverages
                    </button>
                    <button data-category-btn="desserts" onclick="filterMenu('desserts')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
                        <img src="/Peach.png" alt="Desserts" class="h-8 w-8 mr-2"> Desserts
                    </button>
                    <button data-category-btn="palabok" onclick="filterMenu('palabok')" class="category-btn w-full px-4 py-2 flex items-center hover:bg-gray-200 border bg-yellow-100 rounded-lg">
